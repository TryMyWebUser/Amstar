    ...
    $(document).ready(function () {
        ...
        function generateBotResponse(userMessage) {
            ...
            switch (userMessage.toLowerCase()) {
                ...
                case 'what is Maraviya Infotech':
                    return "Maraviya Infotech is an online marketplace where you can buy and sell various types of website templates.";
                case 'list of digital marketplace':
                    return "Demo1 Market, Demo2 Market, Demo3 Market, Demo4 Market, Demo5 Market etc.";
                ...
                case 'future of artificial intelligence?':
                    return "";
                default:
                    return 'I apologize, but I am only understand some pre-defined questions, Just Purchase the template and apply ai algorithems.';
            }
        }
    });
